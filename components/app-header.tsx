  ...
  return (
    <>
      ...
      <nav
        ...
        className="app-mobile-bottom-nav fixed inset-x-4 z-50 grid grid-cols-5 rounded-[1.55rem] border border-slate-200/60 bg-white p-1 shadow-[0_-1px_0_rgba(0,0,0,0.06),0_4px_16px_rgba(0,0,0,0.08)] md:hidden"
      >
        {effectiveNavItems.map((item) => {
