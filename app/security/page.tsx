const sections = [
  ...
  },
  {
    title: "入力値検証",
    items: [
      "発見報告はGoogleフォームへ遷移して受け付けます。アプリ内の問い合わせは文字数制限、URL形式検証、HTMLタグ・script混入検出、honeypot、連続送信対策を行います。",
  ...
  },
  {
    title: "レート制限方針",
    items: [
      "問い合わせは同一ブラウザ・同一連絡先相当で短時間の連続送信を抑制します。発見報告はGoogleフォーム側の保護設定を利用します。",
  ...
  },
  {
    ...
    items: [
      ...
      "不要になった投稿・問い合わせ情報は削除依頼に応じて確認します。"
    ]
  },
  {
    title: "監視と解析",
