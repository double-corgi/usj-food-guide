const sections = [
  ...
  },
  {
    ...
    items: [
      "通常利用では個人情報を収集しません。",
      "このアプリはログイン不要で利用できます。食べた記録、評価、メモ、食べた日、レビュー、星評価、総消費金額用の支払金額は端末内のlocalStorageに保存され、アプリ運営者へ自動送信されません。",
      "発見報告でGoogleフォームに入力された商品名、価格、販売場所、画像URL、公式URL、メモ、任意の送信者名、任意の連絡先。",
  ...
  },
  {
    ...
    items: [
      "食べた記録、レビュー、星評価、総消費金額用の支払金額、最近見た商品、検索履歴、PWA案内の閉じた状態などをブラウザのlocalStorageに保存します。",
  ...
  },
  {
    ...
    items: [
      "発見報告はGoogleフォームを利用します。入力された商品情報、画像URL、公式URL、メモ、任意の連絡先はGoogleフォーム上で管理者確認用に保存されます。",
